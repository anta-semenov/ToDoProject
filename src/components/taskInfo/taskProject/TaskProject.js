    ...
    return (
      <div className='projects'>
        <div className='projects__title'>Project</div>
        {
          ...
          <select className='projects__selector' value={this.props.taskProject} onChange={(e) => this.props.onProjectChange(e.target.options.item(e.target.selectedIndex).value)} >
